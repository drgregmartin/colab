...
While ggplot has a "data" argument that allows you to define what data will be used to generate your plot, you can also feed the data directly into ggplot using pipe operators.

### Mapping aesthetics: 

To tell your data story, you need to tell ggplot which variables are going to mapped against which visual aesthetics that include the x and y axis', color, size, shape etc.
